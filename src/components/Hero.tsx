...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto px-6 pt-32 pb-20 md:pt-40 md:pb-32">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          {/* Left: Content */}
          <div>
            {/* Badge */}
            <motion.div
              className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full border border-white/[0.08] bg-white/[0.03] mb-8"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
            >
              <span className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse" />
              <span className="text-[11px] font-medium text-corporate-gray tracking-wide">
            ...
            >
              <a
                href="#quote"
                className="btn-accent px-8 py-3.5 text-[15px] font-semibold gap-2"
              >
                Get a Quote
              ...
              <a
                href="#services"
                className="btn-outline px-8 py-3.5 text-[15px] font-semibold"
              >
                Explore Services
              </a>
            </motion.div>
            ...
            {/* Trust line */}
            <motion.div
              className="flex items-center gap-6 text-[11px] text-corporate-gray font-medium"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  <div className="w-9 h-9 rounded-xl bg-white/[0.06] flex items-center justify-center mb-3 group-hover:bg-accent/20 transition-colors duration-500">
            ...
            {/* Stats card */}
            <motion.div
              className="col-span-2 p-5 rounded-2xl border border-white/[0.06] bg-gradient-to-br from-white/[0.03] to-transparent"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{
                delay: 1,
