...
export default function WhatWeBuild() {
  ...
  return (
    <section id="whatwbuild" className="relative py-40 px-6 bg-black">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {offerings.map((offering, index) => {
            ...
            return (
              <motion.div
                key={offering.title}
                className="group relative bg-secondary-bg rounded-[32px] p-12 transition-all duration-700 hover:bg-[#1d1d1f] border border-white/[0.04]"
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-black flex items-center justify-center mb-8 group-hover:bg-accent transition-colors duration-500">
